...
export function HeroSection() {
  return (
    <section className="relative flex min-h-screen items-end overflow-hidden">
      ...
      >
        <source src="/videos/hero-combat.mp4" type="video/mp4" />
      </video>
      ...
      <Container className="relative z-10 flex w-full pb-16 pt-32 sm:pb-20 lg:pb-24">
        <div className="max-w-4xl">
          ...
          <h1 className="headline-display max-w-4xl text-white text-wrap-balance">
            Asimetrik Tehditlere Karşı Çevik Çözümler.
          </h1>
          ...
          <div className="mt-10 flex flex-col items-start gap-4 sm:flex-row">
            ...
            <a
              href="#hikaye"
              className="inline-flex items-center justify-center rounded-brand border border-white/24 bg-white/8 px-6 py-3.5 font-sans text-sm font-semibold text-white transition-colors duration-200 hover:bg-white/14"
            >
              Hikâyeyi Keşfedin
            </a>
          </div>
